...
Persona::Persona(string pNombre, string pApellidos, int pCedula, string pDomicilio) {
    nombre = pNombre;
...
void Persona::setDomicilio(string pDomicilio) {
    domicilio = pDomicilio;
}

string Persona::toString() {
    std::ostringstream s;
    s << nombre << ", " << apellidos << ", " << cedula << ", " << domicilio;
    return s.str();
